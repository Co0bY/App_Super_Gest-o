        ...
        <div class="informacao-pagina">
            <div style="width: 90%; margin-left:auto; margin-right:auto;">
                        ...
                        @foreach ($fornecedores as $fornecedor)
                            ...
                            <tr>
                                <td colspan="6">
                                    ...
                                    <table border="1" style="margin:20px; width:97%;">
                                        <thead>
                                            <tr>
                                                <th >ID</th>
                                                <th >Nome</th>
                ...
                <div style="max-width: 20%; max-height:20%; display:inline;">
                    ...
                    Exbiindo {{ $fornecedores->count()}} fornecedores de {{ $fornecedores->total()}} (de {{ $fornecedores->firstitem()}} a {{ $fornecedores->lastitem()}})
                </div>
